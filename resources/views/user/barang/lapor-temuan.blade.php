...
<x-app-layout>
    <div class="bg-[#f0f9ff] pt-20 sm:pt-28 md:pt-32 sm:pb-10 px-0 sm:px-4 md:px-[100px]">
        <div class="bg-white max-w-[1232px] sm:mx-8 md:mx-auto p-8 rounded-none sm:rounded-[20px] shadow">
            <h2 class="text-[28px] text-[#193a6f] font-bold font-['Poppins'] mb-2">Lapor Barang Temuan</h2>
            <p class="text-[16px] text-black font-normal font-['Poppins'] mb-4">
                Menemukan barang yang bukan milikmu? Isi formulir berikut untuk membantu pemilik yang kehilangan
                menemukan barangnya. Cantumkan detail lokasi, foto, dan ciri-ciri barang agar mudah dikenali oleh
                pemilik.
            </p>
